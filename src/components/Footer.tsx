      ...
      <div className="container mx-auto px-6 py-12 md:py-16">
        ...
        <div className="mt-10 pt-8 border-t border-primary-foreground/10">
          ...
          <p className="mt-6 text-xs text-primary-foreground/40 text-center">
            Optimum Health and Wellness Clinic | After-Hours Physician Pharr | Family Clinic McAllen | Evening Clinic Texas | Cash Pay Clinic RGV | Same-Day Physician RGV | Family Medicine South Texas | Walk-in Clinic Pharr | After Hours Care McAllen
          </p>
        </div>
      </div>
    </footer>
